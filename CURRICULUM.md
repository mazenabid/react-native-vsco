...
| 05 | Photo permissions and gallery | Device permissions, Media Library APIs, asynchronous work, and performant lists | A responsive grid of photos from the user's device | In progress | [Journal](./docs/modules/05-photo-permissions-and-gallery.md) · [Issue #7](https://github.com/mazenabid/react-native-vsco/issues/7) |
